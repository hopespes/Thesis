...
from my_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as vanilla_mcts
...
def mcts_player_2_builder(network, ckpt_file, device, model):
    ...
    if mode == 1:
        ...
        from my_alpha_zero.core.pipeline import create_mcts_player as mcts_2
        player_2 = mcts_2
