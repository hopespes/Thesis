...
#ifndef OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_MCTS_H_
#define OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_MCTS_H_
...
class Evaluator {
 public:
  ...
  virtual ActionsAndProbs Prior(const State& state) = 0;
	...
	virtual double Certainty(const State& state) = 0;
};
