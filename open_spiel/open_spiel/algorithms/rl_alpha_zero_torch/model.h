...
#ifndef OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_TORCH_MODEL_H_
#define OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_TORCH_MODEL_H_
...
//   
//   [Input Tensor]   --> CONV --> BN --> RELU --> LIN (no SOFTMAX here)
//
//                    --> CONV --> BN --> RELU --> LIN --> RELU --> LIN --> TANH
//
...
class ResOutputBlockImpl : public torch::nn::Module {
 ...
 private:
  ...
  torch::nn::Conv2d certainty_conv_;
  torch::nn::BatchNorm2d certainty_batch_norm_;
  torch::nn::Linear certainty_linear1_;
  torch::nn::Linear certainty_linear2_;
  int certainty_observation_size_;
};
