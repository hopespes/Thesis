...
Then, to get started, see `examples/vanilla_alpha_zero_torch_example.cc`.
...
`vanilla_alpha_zero_torch_example`:
```sh
$ ./build/examples/vanilla_alpha_zero_torch_example --game=tic_tac_toe --path=/home/me/az_example/
```
...
positional argument:
```sh
$ ./build/examples/vanilla_alpha_zero_torch_example /home/me/az_example/config.json
```

## Playing a Trained LibTorch AlphaZero

A trained LibTorch AlphaZero can be played by running
`vanilla_alpha_zero_torch_game_example`:
```sh
$ ./build/examples/vanilla_alpha_zero_torch_game_example --game=tic_tac_toe --player1=az --player2=mcts --az_path=/home/me/az_example/ --az_checkpoint=-1
```
Run with the `--help` flag to see a complete list of flags and a brief
description of each.
