...
#ifndef OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_TORCH_VPEVALUATOR_H_
#define OPEN_SPIEL_ALGORITHMS_RL_ALPHA_ZERO_TORCH_VPEVALUATOR_H_
...
class VPNetEvaluator : public Evaluator {
 public:
  ...
  double Certainty(const State& state) override;
