...
#include "open_spiel/algorithms/simple/top_bot_2_alpha_zero_torch/alpha_zero.h"
...
#include "open_spiel/algorithms/simple/top_bot_2_alpha_zero_torch/device_manager.h"
#include "open_spiel/algorithms/simple/top_bot_2_alpha_zero_torch/vpevaluator.h"
#include "open_spiel/algorithms/simple/top_bot_2_alpha_zero_torch/vpnet.h"
#include "open_spiel/algorithms/simple/top_bot_2_alpha_zero_torch/mcts.h"
  ...
  while (true) {
    if (state->IsChanceNode()) {
      ...
      std::unique_ptr<SearchNode> root = 
          (*bots)[player]->MCTSearch(*state, simulations);
      open_spiel::ActionsAndProbs policy;
