...
int main(int argc, char** argv) {
  open_spiel::algorithms::torch_haz::TestModelCreation();
  open_spiel::algorithms::torch_haz::TestModelInference();
  open_spiel::algorithms::torch_haz::TestCUDAAVailability();
}
