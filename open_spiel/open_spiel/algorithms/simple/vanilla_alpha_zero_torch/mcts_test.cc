...
#include "open_spiel/algorithms/simple/vanilla_alpha_zero/mcts.h"
...
using open_spiel::algorithms::torch_az::Evaluator;
using open_spiel::algorithms::torch_az::RandomRolloutEvaluator;
