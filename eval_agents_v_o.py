...
from my_alpha_zero.alpha_zero.envs.go import GoEnv
from my_alpha_zero.alpha_zero.core.network import AlphaZeroNet
from my_alpha_zero.alpha_zero.core.pipeline import set_seed, disable_auto_grad, maybe_create_dir
from my_alpha_zero.alpha_zero.utils.util import create_logger, get_time_stamp
from my_alpha_zero.alpha_zero.utils.csv_writer import CsvWriter
...
def mcts_player_1_builder(network, ckpt_file, device, model):
    ...
    player_1 = None
    if mode == 1:
        from top_k_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_1
        player_1 = mcts_1
    elif mode == 2:
        from top_bot_k_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_1
        player_1 = mcts_1
    elif mode == 3:
        from rand_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_1
        player_1 = mcts_1
    else:
        from my_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_1
        player_1 = mcts_1
...
def mcts_player_2_builder(network, ckpt_file, device, model):
    ...
    player_2 = None
    if mode == 1:
        from top_k_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_2
        player_2 = mcts_2
    elif mode == 2:
        from top_bot_k_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_2
        player_2 = mcts_2
    elif mode == 3:
        from rand_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_2
        player_2 = mcts_2
    else:
        from my_alpha_zero.alpha_zero.core.pipeline import create_mcts_player as mcts_2
        player_2 = mcts_2
...
def play_one_match(
    ...
    black_player = mcts_player_1_builder(black_network, black_ckpt, device)
    white_player = mcts_player_2_builder(white_network, white_ckpt, device)
